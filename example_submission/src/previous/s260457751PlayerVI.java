...
/**
 * Player with a pseudo monte carlo rollout
 */
public class s260457751PlayerVI extends Player {
    Random rand = new Random();
    
    /** Provide a default public constructor */
    public s260457751PlayerVI() { super("LDFS"); }
    public s260457751PlayerVI(String s) { super(s); }
    ...
    public Move chooseMove(Board theboard) 
    {
        ...
        if(mov != null && board.isLegal(mov))
        	...
        	m = IterativeDepthTools.getBestMoveToDepthWithMC(board, playerID, 1);
        }
