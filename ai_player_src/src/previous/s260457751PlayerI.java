...
/**
 * Slightly improved Halma player, originally uses moded minimax
 */
public class sXXXXXXXXXPlayerI extends Player {
    Random rand = new Random();
    
    /** Provide a default public constructor */
    public sXXXXXXXXXPlayerI() { super("improved"); }
    public sXXXXXXXXXPlayerI(String s) { super(s); }
